...
class Rcon
{
   ...
   * @return bool|string The response from the server or false if not connected.
   */
  ...
  /**
   * Authorizes the RCON connection.
   *
   ...
   *
   * @param int $packet_id Packet ID.
   * @param int $packet_type Packet type.
   * @param string $packet_body Packet body.
   */
  ...
  /**
   * Reads a packet from the socket stream.
   *
   * @return array Packet information.
   */
