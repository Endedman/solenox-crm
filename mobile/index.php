...
try {
    ...
    $subcategories = $appManager->getSubcategories();
...
<body>
    <div data-role="page" data-theme="<?php if (isset($_COOKIE['theme'])) {
        ...
        <div data-role="header">
            <a href="#" data-role="button" data-rel="back" data-icon="arrow-l" data-iconpos="notext"
        ...
        <div data-role="content">
            ...
            <ul data-role="listview">
                <?php foreach ($subcategories as $subcategory): ?>
                    <!-- <li><a href="subcategory/<?php echo $subcategory['id']; ?>" data-transition="slide"><?php echo $subcategory['name']; ?></a></li> -->
                <?php endforeach; ?>
            </ul>
            <h2>
                <?= $lang['categories']; ?>
            ...
            <ul data-role="listview">
                <?php foreach ($categories as $category): ?>
                    <li><a href="category/<?php echo $category['id']; ?>" data-transition="slide">
