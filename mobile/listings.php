...
try {
    ...
    $items = $listingsManager->getItemsList();
        ...
        <div data-role="content">
            ...
            <ul data-role="listview">
                <?php foreach ($items as $item): ?>
                    <li>
                        <a href="/<?= JSTORE_WEB_MOBILE_SHORT_DIR ?>good/<?php echo $item['id']; ?>" data-transition="pop">
                            <h2>
                                <?php echo $item['title']; ?>
                            </h2>
                            <p>
                            ...
                            <!-- <img src="path/to/screenshots/<?php echo $item['screenshot']; ?>"> -->
                        </a>
                    </li>
                <?php endforeach; ?>
            </ul>
