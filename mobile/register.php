...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['username'], $_POST['email'], $_POST['password'], $_POST['confirm_password'])) {
        $role = 1;
        $message = $user->register($_POST['username'], $_POST['email'], $_POST['password'], $_POST['confirm_password'], $role);
    } else {
...
<body>
<div data-role="page" data-theme="<?php if(isset($_COOKIE['theme'])) {echo $_COOKIE['theme'];}?>">
    ...
    <div data-role="main" class="ui-content">
        <form method="post" action="/<?= JSTORE_WEB_MOBILE_SHORT_DIR?>register">
    ...
    <div data-role="panel" id="mypanel" data-display="overlay" data-position="right">
        ...
        <ul data-role="listview">
                <?php if (isset($_COOKIE['username']) && isset($_SESSION['user_id'])): ?>
                    <li><a href="/<?= JSTORE_WEB_MOBILE_SHORT_DIR?>profile" data-transition="pop"><?= $lang['profile'];?></a></li>
                <?php else: ?>
                    <li><a href="/<?= JSTORE_WEB_MOBILE_SHORT_DIR?>login" data-transition="pop"><?= $lang['login'];?></a></li>
                    <li><a href="/<?= JSTORE_WEB_MOBILE_SHORT_DIR?>register" data-transition="pop"><?= $lang['register'];?></a></li>
                <?php endif; ?>
            <!-- Кнопки для смены языка -->                    
            <li><a href="/<?= JSTORE_WEB_MOBILE_SHORT_DIR?>top" data-transition="pop"><?= $lang['top'];?></a></li>
            <li><a href="/<?= JSTORE_WEB_MOBILE_SHORT_DIR?>listings" data-transition="pop"><?= $lang['listings'];?></a></li>
    ...
    <a href="#dialog" data-rel="dialog" data-role="table" data-corners="false"><?= JSTORE_BRAND_NAME ?></a>
    </div><!-- /footer -->
</div><!-- /page -->
